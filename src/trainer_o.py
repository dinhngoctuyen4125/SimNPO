...
class Trainer:
    ...
    def _remove_unused_columns(self, dataset: "datasets.Dataset", description: Optional[str] = None):
        ...
        ###modified
        signature_columns = self._signature_columns # + [i + "_retain" for i in self._signature_columns]
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        if is_datasets_available() and isinstance(train_dataset, datasets.Dataset):
            ...
            train_dataset.forget_dataset = self._remove_unused_columns(train_dataset.forget_dataset, description="training")
            train_dataset.retain_dataset = self._remove_unused_columns(train_dataset.retain_dataset, description="training")
